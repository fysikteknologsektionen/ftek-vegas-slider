...
class vegas{
    ...
    public function vegas_metaboxes_add() {
        add_meta_box( 'vegas_images', __( 'Vegas Slides', 'vegas' ), array( $this, 'vegas_meta_box_image' ), 'vegas', 'normal', 'default' );
        add_meta_box( 'vegas_selected', __( 'Vegas Default', 'vegas' ), array( $this, 'vegas_meta_box_selected' ), 'vegas', 'normal', 'default' );
	    add_meta_box( 'vegas_shortcode', __( 'Vegas Shortcode', 'vegas' ), array( $this, 'vegas_meta_box_shortcode' ), 'vegas', 'normal', 'default' );  //shortcode generator
    }

    //Display images metabox
    public function vegas_meta_box_image() {
        include_once('methods/metaboxes/vegas_image_metabox.php'); 
    }

    //Display selected metabox
    public function vegas_meta_box_selected() {
        include_once('methods/metaboxes/vegas_selected_metabox.php'); 
    }
